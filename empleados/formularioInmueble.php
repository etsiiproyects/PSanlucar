...
<body>
	...
	<div class="iniciosesion">
		...
		<form id="registro" method="get" action="validacion_inmueble.php" onsubmit="return validateForm()">
				...
				<input class="input-group" id="id_inmueble" name="id_inmueble" type="text" size="10" value="<?php echo $formulario['id_inmueble'];?>" required />
				<br />
				...
				<input class="input-group" type="number" id="habitaciones" name="habitaciones" value="<?php echo $formulario['habitaciones'];?>" required />
				<br />
			<br>
