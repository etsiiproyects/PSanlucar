...
<body>
	...
	<div class="iniciosesion">
		...
		<form id="registro" method="get" action="validacionModificaInmueble.php">
			...
			<input class="input-group" id="id_inmueble" name="id_inmueble" type="text" value="<?php echo $inmueble['ID_INMUEBLE'] ?>" />
			<br />
			<label for="direccion">Dirección: </label>
			<input class="input-group" id="direccion" name="direccion" type="text" value="<?php echo $inmueble['DIRECCION'] ?>" />
			<br />
			<label for="habitaciones">Habitaciones: </label>
			<input class="input-group" id="habitaciones" name="habitaciones" type="number" value="<?php echo $inmueble['HABITACIONES'] ?>" />
			<br />
			...
			<input class="input-group" id="imagen" name="imagen" type="text" size="40" value="<?php echo $inmueble['IMG'] ?>" />
			<br />
