...
CREATE OR REPLACE PROCEDURE INSERTAR_CONTRATO
    ...
    w_OIDD IN CONTRATOS.OID_D%TYPE) IS
BEGIN
    INSERT INTO CONTRATOS(INICIOALQUILER, FINALQUILER, PAGOMENSUAL, FIANZA, OID_D) VALUES (W_INICIO,W_FIN,W_PAGO,W_FIANZA,W_OIDD);
END;
/
